...
public class DBViewedFilms {
    private static final String DATABASE_NAME = "Viewed_Films.db";
    private static final int DATABASE_VERSION = 1;
    private static final String TABLE_NAME = "viewed";
    ...
    public DBViewedFilms(Context context) {
        DBViewedFilms.OpenHelper mOpenHelper = new DBViewedFilms.OpenHelper(context);
